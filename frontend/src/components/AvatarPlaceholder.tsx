...
const sizeMap: Record<NonNullable<AvatarPlaceholderProps['size']>, { container: string; text: string }> = {
...
const RING_PADDING: Record<NonNullable<AvatarPlaceholderProps['size']>, string> = {
  xs:    '2px',
  sm:    '2px',
  md:    '3px',
  lg:    '3px',
...
const GAP_PADDING: Record<NonNullable<AvatarPlaceholderProps['size']>, string> = {
  xs:    '1px',
  sm:    '1.5px',
  md:    '2px',
  lg:    '2.5px',
